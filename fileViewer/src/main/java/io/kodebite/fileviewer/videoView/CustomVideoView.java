...
public class CustomVideoView extends SurfaceView
    ...
    public CustomVideoView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mFitXY = a.getBoolean(R.styleable.CustomVideoView_videoview_fitXY, false);
        mAutoRotation = a.getBoolean(R.styleable.CustomVideoView_videoview_autoRotation, false);
        a.recycle();
        initVideoView();
    }
    ...
    public void setMediaController(VideoMediaController controller) {
        if (mMediaController != null) {
